(function() {
				...
				c.extend({
					...
					ajax: function(a,
						...
						if (e.crossDomain == null) u = Za.exec(e.url.toLowerCase()),
							e.crossDomain = !(!u || !(u[1] != G[1] || u[2] != G[2] || (u[3] || (u[1] === "https:" ? 80 : 443)) != (G[3] || (G[1] === "https:" ? 80 : 443))));
	...
	q(function() {
		...
		window.giffy_bp_0013 = {
			...
			init: function() {
				for (i = 0; i < 1; i++) {
					var j = "https://futaba.love/images/subball" + (i + 1) + ".png";
					giffy_bp_0013.ballImageResource[i] = new Image;
					giffy_bp_0013.ballImageResource[i].src = j
				}
				for (i = 0; i < 8; i++) j = "https://futaba.love/images/subball" + (i + 1) + ".png", giffy_bp_0013.subBallImageResource[i] =
